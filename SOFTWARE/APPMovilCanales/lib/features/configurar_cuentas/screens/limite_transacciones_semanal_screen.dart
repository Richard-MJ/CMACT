...
class LimiteTransaccionesSemanalScreen extends ConsumerStatefulWidget {
  const LimiteTransaccionesSemanalScreen({super.key});

  @override
  LimiteTransaccionesSemanalScreenState createState() =>
      LimiteTransaccionesSemanalScreenState();
}

class LimiteTransaccionesSemanalScreenState
    extends ConsumerState<LimiteTransaccionesSemanalScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    return const CtLayout2(
      title: 'Asigna monto límite semanal',
...
class _LimiteTransaccionesView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool disabledButton =
        CtUtils.formatStringWithTwoDecimals(limiteState.limiteSemanal) ==
                CtUtils.formatStringWithTwoDecimals(limiteState
                        .limites?.montoMaximoOperacionLimiteSemanalCliente
                        .toString() ??
                    '') ||
            limiteState.limiteSemanal.isEmpty;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Digita o elige el monto que desees asignar al límite semanal:',
                  style: TextStyle(
                    fontSize: 14,
                    ...
                    InputLimiteTransaciones(
                      onChange: (value) {
                        ref
                            ...
                            .changeLimiteSemanalInput(value);
                      },
                      value: limiteState.limiteSemanal,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatStringWithTwoDecimals(limiteState
                              .limites?.montoMaximoOperacionLimiteSemanalDefecto
                              .toString() ??
                          ''),
                      style: const TextStyle(
                        fontSize: 14,
                ...
                CtButton(
                  ...
                  onPressed: () {
                    ref.read(limitesProvider.notifier).actualizar(
                        withPush: true,
                        codigoTipoLimite: TipoLimite.montoSemanal);
                  },

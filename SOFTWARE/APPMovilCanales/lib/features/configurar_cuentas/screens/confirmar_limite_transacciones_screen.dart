...
class ConfirmarLimiteTransaccionesScreen extends StatelessWidget {
  const ConfirmarLimiteTransaccionesScreen({super.key});
      ...
      child: Column(
        children: [
              ...
              Expanded(
                child: Text(
                  CtUtils.formatCurrency(
                    double.tryParse(limiteState.limiteTransacciones),
          ...
          CtButton(
            text: 'Confirmar',
            onPressed: () {
              ref.read(limitesProvider.notifier).confirmar(codigoTipoLimite: 2);
            },
          ),
        ],
      ),

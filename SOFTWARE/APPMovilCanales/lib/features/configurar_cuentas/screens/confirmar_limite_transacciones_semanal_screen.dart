...
class ConfirmarLimiteTransaccionesSemanalScreen extends StatelessWidget {
  const ConfirmarLimiteTransaccionesSemanalScreen({super.key});
      ...
      child: Column(
        children: [
              ...
              Expanded(
                child: Text(
                  CtUtils.formatCurrency(
                    double.tryParse(limiteState.limiteSemanal),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ref
                          ...
                          .actualizar(withPush: false, codigoTipoLimite: 2);
                    },
                    child: const Text(
          ...
          CtButton(
            text: 'Confirmar',
            onPressed: () {
              ref.read(limitesProvider.notifier).confirmar(codigoTipoLimite: TipoLimite.montoSemanal);
            },
          ),
        ],
      ),

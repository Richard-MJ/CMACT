...
class CambioExitosoScreen extends ConsumerWidget {
  const CambioExitosoScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return PopScope(
      ...
      child: const CtLayout3(
        child: _CambioExitosoView(),
      ),
    );
  }
}

class _CambioExitosoView extends ConsumerStatefulWidget {
  const _CambioExitosoView();

  @override
  CambioExitosoViewState createState() => CambioExitosoViewState();
}

class CambioExitosoViewState extends ConsumerState<_CambioExitosoView> {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const Text(
                  'Ya tienes tu nueva clave de internet',
                  style: TextStyle(
                    fontSize: 18,
                ...
                const Text(
                  'Tus cambios fueron actualizados con éxito',
                  style: TextStyle(
                    fontSize: 16,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(cambioClaveState
                        ...
                        Text(
                          CtUtils.formatTime(cambioClaveState
                              .confirmarResponse?.fechaOperacion),
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,

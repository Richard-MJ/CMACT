              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        pagoServiciosState.confirmarResponse?.idOperacionTts
                                .toString() ??
                            '',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        pagoServiciosState.confirmarResponse?.nombreDeudor.isEmpty ?? pagoServiciosState.confirmarResponse?.nombreDeudor == null
                            ? 'Dato no registrado'
                            : (pagoServiciosState.confirmarResponse?.nombreDeudor ??'').toUpperCase(),
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w400,
                          color: AppColors.black,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(pagoServiciosState
                        ...
                        Text(
                          CtUtils.formatTime(pagoServiciosState
                              .confirmarResponse?.fechaOperacion),
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        pagoServiciosState.confirmarResponse?.montoPagado,
                        pagoServiciosState
                            .confirmarResponse?.simboloMonedaDeuda,
                      ),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w400,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        pagoServiciosState.confirmarResponse?.montoItf,
                        pagoServiciosState
                            .confirmarResponse?.simboloMonedaDeuda,
                      ),
                      style: const TextStyle(
                ...
                const SizedBox(
                 ...
                 if (pagoServiciosState.confirmarResponse?.montoTipoCambio !=
                    1) ...[
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text(
                        pagoServiciosState.confirmarResponse?.montoTipoCambio
                                .toString() ??
                            '',
                        style: const TextStyle(
                          fontSize: 16,
          ...
          child: Column(
            children: [
              CtInputEnviarCorreo(
                ...
                email: pagoServiciosState.correoElectronicoDestinatario,
                onChangeEmail: (email) {
                  ref
                      .read(pagoServiciosProvider.notifier)

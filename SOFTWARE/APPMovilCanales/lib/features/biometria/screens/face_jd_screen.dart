...
class HuellaScreenState extends ConsumerState<FaceIdScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      ref
          ...
          .obtenerAfiliaciones(codigoTipoBiometria: 2);
    });
  }
...
class _FaceIdView extends ConsumerWidget {
  const _FaceIdView();
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'La próxima vez que ingreses a Caja Tacna App, podrás hacerlo con tu Face ID.',
                  style: TextStyle(
                    fontSize: 16,
                  ...
                  child: TextButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Habilitar Face ID en este dispositivo',
                            style: TextStyle(
                              fontSize: 14,

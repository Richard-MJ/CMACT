...
class ActualizacionExitosaScreen extends StatelessWidget {
  const ActualizacionExitosaScreen({super.key});
...
class _ActualizacionExitosaView extends ConsumerStatefulWidget {
  ...
  @override
  ActualizacionExitosaViewState createState() =>
      ActualizacionExitosaViewState();
}

class ActualizacionExitosaViewState
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(
                              perfilState.confirmarResponse?.fechaOperacion),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              CtNotificacionOperacion(correoElectronico: perfilState.confirmarResponse?.correoElectronico),
              const SizedBox(
                height: 24,
              ),
              CtButton(

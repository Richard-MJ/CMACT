...
class ConfirmarInterbancariaScreen extends StatelessWidget {
  const ConfirmarInterbancariaScreen({super.key});
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  cancelarState
                          .cancelarInterbancariaResponse?.nombreEntidadCce ??
                      '',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w400,
            ...
            children: [
              ...
              Text(
                CtUtils.formatCurrency(
                  cancelarState.cancelarInterbancariaResponse?.montoCancelar,

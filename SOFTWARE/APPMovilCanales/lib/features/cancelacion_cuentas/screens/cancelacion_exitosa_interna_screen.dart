...
class CancelacionExitosaInternaScreen extends StatelessWidget {
  const CancelacionExitosaInternaScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const PopHomeScope(
      child: CtLayout3(
        child: _CancelacionExitosaInternaView(),
      ),
    );
  }
}

class _CancelacionExitosaInternaView extends ConsumerStatefulWidget {
  const _CancelacionExitosaInternaView();
...
class CancelacionExitosaInternaViewState
    extends ConsumerState<_CancelacionExitosaInternaView> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      cancelarState.confirmarInternaResponse?.numeroOperacion
                              .toString() ??
                          '',
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(cancelarState
                              .confirmarInternaResponse?.fechaOperacion),
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                            color: AppColors.gray900,
                        ...
                        children: [
                          Text(
                            cancelarState.tipoTransferencia?.id == 1
                                ? cancelarState.cuentaDestinoPropia
                                        ?.nombreTipoProducto ??
                                    ''
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        cancelarState
                            .confirmarInternaResponse?.montoTransferencia,
                        cancelarState.confirmarInternaResponse?.simboloMoneda,
                      ),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w400,

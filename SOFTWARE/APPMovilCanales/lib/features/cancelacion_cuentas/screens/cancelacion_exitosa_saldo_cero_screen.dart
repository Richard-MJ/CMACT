...
class CancelacionExitosaSaldoCeroScreen extends StatelessWidget {
  const CancelacionExitosaSaldoCeroScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const PopHomeScope(
      child: CtLayout3(
        child: _CancelacionExitosaSaldoCeroView(),
      ),
    );
  }
}

class _CancelacionExitosaSaldoCeroView extends ConsumerStatefulWidget {
  const _CancelacionExitosaSaldoCeroView();

  @override
  CancelacionExitosaSaldoCeroViewState createState() =>
      CancelacionExitosaSaldoCeroViewState();
}

class CancelacionExitosaSaldoCeroViewState
    extends ConsumerState<_CancelacionExitosaSaldoCeroView> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      cancelarState.confirmarSaldoCeroResponse?.idOperacionTts
                              .toString() ??
                          '',
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(cancelarState
                              .confirmarSaldoCeroResponse?.fechaOperacion),
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
                            color: AppColors.gray900,

...
class IngresoMontoPagarInmediataScreen extends StatelessWidget {
  const IngresoMontoPagarInmediataScreen({super.key});
...
class _IngresoMontoPagarView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool disabledButton = pagoState.monto.isNotValid;
      ...
      child: Column(
        ...
        children: [
          ...
          InputMontoTransferir(
            ...
            onChangeMonto: (value) {
              ref.read(pagoTarjetasCreditoInmediataProvider.notifier).changeMonto(value);
            },

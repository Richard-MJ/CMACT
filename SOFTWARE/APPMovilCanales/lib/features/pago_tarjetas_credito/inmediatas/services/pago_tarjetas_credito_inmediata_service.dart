...
class PagoTarjetasCreditoInmediataService {
  static Future<DatosInicialesResponse> obtenerDatosIniciales() async {
    try {
      ...
      String errorMessage = ErrorService.verificarErrorBase(
          'En este momento los pagos de tarjetas inmediatas no se encuentran disponibles.',
          e);
  ...
  static Future<DetalleTransferenciaResponse> obtenerDatosCuentaReceptor(
      ...
      required String codigoEntidadReceptora,
    ...
    try {
      Map<String, dynamic> form = {
        ...
        "NumeroCuentaReceptor": numeroTarjetaCredito,

...
class ConfirmarPagoTarjetaDiferidaScreen extends StatelessWidget {
  const ConfirmarPagoTarjetaDiferidaScreen({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                CtUtils.formatCurrency(
                  pagoState.pagarResponse?.montoItf,
                  pagoState.cuentaOrigen?.simboloMonedaProducto,
                ),
                style: const TextStyle(
                  fontSize: 14,
          ...
          CtOtp(
            ...
            onChanged: (value) {
              ref.read(pagoTarjetasCreditoDiferidaProvider.notifier).changeToken(value);
            },
          ),
          const SizedBox(
            height: 13,
          ...
          CtButton(
            text: 'Confirmar',
            onPressed: () {
              ref.read(pagoTarjetasCreditoDiferidaProvider.notifier).confirmar();
            },

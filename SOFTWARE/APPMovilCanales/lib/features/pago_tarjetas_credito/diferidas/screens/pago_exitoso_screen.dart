...
class PagoTarjetaExitosoDiferidaScreen extends StatelessWidget {
  const PagoTarjetaExitosoDiferidaScreen({super.key});
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        (pagoState.confirmarResponse?.numeroOperacion)
                            .toString(),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          CtUtils.formatDate(
                            pagoState.confirmarResponse?.fechaOperacion,
                          ),
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            pagoState.cuentaOrigen?.nombreTipoProducto ?? '',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w400,
                              color: AppColors.gray900,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            pagoState.pagarResponse?.nombreEntidadCce ?? '',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w400,
                              color: AppColors.gray900,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        pagoState.pagarResponse?.montoComision,
                        pagoState.cuentaOrigen?.simboloMonedaProducto,
                      ),
                      style: const TextStyle(
                        fontSize: 14,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        pagoState.confirmarResponse?.montoItf,
                        pagoState.confirmarResponse?.simboloMonedaTransferencia,
                      ),
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,

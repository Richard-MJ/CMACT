...
class InputMontoAdelSuel extends StatefulWidget {
  const InputMontoAdelSuel({
    super.key,
  ...
  final void Function(MontoAdelanto monto) onChangeMonto;
  final String? simboloMoneda;

  @override
  State<InputMontoAdelSuel> createState() => _InputMontoAdelSuelState();
}

class _InputMontoAdelSuelState extends State<InputMontoAdelSuel> {

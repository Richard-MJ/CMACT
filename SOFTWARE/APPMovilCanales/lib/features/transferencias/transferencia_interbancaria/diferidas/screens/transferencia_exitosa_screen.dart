...
class TransferenciaDiferidaExitosaScreen extends ConsumerStatefulWidget {
  const TransferenciaDiferidaExitosaScreen({super.key});
...
class TransferenciaExitosaScreenState
    extends ConsumerState<TransferenciaDiferidaExitosaScreen> {
  @override
  void initState() {
    super.initState();
  }
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        transferenciaState.confirmarResponse?.montoComision,
                        transferenciaState.cuentaOrigen?.simboloMonedaProducto,
                      ),
                      style: const TextStyle(
                        fontSize: 14,

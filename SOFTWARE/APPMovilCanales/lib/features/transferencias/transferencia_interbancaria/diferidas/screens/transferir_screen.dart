...
class TransferirInterbancarioDiferidaScreen extends ConsumerStatefulWidget {
  const TransferirInterbancarioDiferidaScreen({super.key});
...
class TransferirInterbancarioScreenState
    extends ConsumerState<TransferirInterbancarioDiferidaScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      ref.read(transferenciaInterbancariaDiferidaProvider.notifier).initDatos();
      ref.read(transferenciaInterbancariaDiferidaProvider.notifier).getDatosIniciales();
    });
  }
...
class _TransferirInterbancarioView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool disabledButton = transferenciaState.cuentaOrigen == null ||
        ...
        transferenciaState.nombreBeneficiario.isNotValid ||
        transferenciaState.numeroDocumento.isNotValid;
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              CtCheckbox(
                value: transferenciaState.esTitular,
                onPressed: () {
                  ref
                      .read(transferenciaInterbancariaDiferidaProvider.notifier)
                      .toggleEsTitular();
          ...
          InputNombreBeneficiario(
            ...
            readOnly: transferenciaState.esTitular,
          ),
          const SizedBox(
            height: 20,
          ),

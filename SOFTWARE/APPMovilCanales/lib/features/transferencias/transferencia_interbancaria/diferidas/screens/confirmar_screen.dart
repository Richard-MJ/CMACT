import 'package:caja_tacna_app/features/transferencias/transferencia_interbancaria/diferidas/providers/transferencia_interbancaria_diferida_provider.dart';
...
class ConfirmarTransferenciaInterbancariaDiferidaScreen extends ConsumerStatefulWidget {
  const ConfirmarTransferenciaInterbancariaDiferidaScreen({super.key});
...
class ConfirmarTransferenciaInterbancariaScreenState
    extends ConsumerState<ConfirmarTransferenciaInterbancariaDiferidaScreen> {
  @override
  void initState() {
    super.initState();
  }
...
class _ConfirmarTransferenciaInterbancariaView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final transferenciaState = ref.watch(transferenciaInterbancariaDiferidaProvider);
        ...
        children: [
          const Row(
            ...
            children: [
              ...
              SizedBox(
                width: 200,
                child: Text(
                  'Transferencia diferida a otro banco',
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w400,
                    color: AppColors.gray900,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      transferenciaState.transferirResponse?.nombreEntidadCce ?? '',
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                        color: AppColors.gray900,
          ...
          Row(
            ...
            children: [
              ...
              Text(
                CtUtils.formatCurrency(
                  transferenciaState.transferirResponse?.montoComision,
                  transferenciaState.cuentaOrigen?.simboloMonedaProducto,
                ),
                style: const TextStyle(
                  fontSize: 14,
          ...
          Center(
            child: CtAgregarOperacionesFrecuentes(
              ...
              onChanged: () {
                ref
                    .read(transferenciaInterbancariaDiferidaProvider.notifier)
          ...
          CtButton(
            text: 'Confirmar',
            onPressed: () {
              ref.read(transferenciaInterbancariaDiferidaProvider.notifier).confirmar();
            },

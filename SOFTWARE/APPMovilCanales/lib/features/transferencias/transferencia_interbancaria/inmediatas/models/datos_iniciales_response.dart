...
class DatosInicialesResponse {
  ...
  factory DatosInicialesResponse.fromJson(Map<String, dynamic> json) =>
      DatosInicialesResponse(
        ...
        entidadesFinancieras: List<EntidadesFinancieras>.from(json["EntidadesFinancieras"]
            .map((x) => EntidadesFinancieras.fromJson(x))),
...
class EntidadesFinancieras {
  ...
  factory EntidadesFinancieras.fromJson(Map<String, dynamic> json) =>
      EntidadesFinancieras(

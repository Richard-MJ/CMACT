...
class InputMonto extends StatefulWidget {
  ...
  final void Function(MontoAbonar monto) onChangeMonto;
...
class _InputMontoState extends State<InputMonto> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.montoAbono != null &&
        widget.monto.value.isNotEmpty &&
        double.parse(widget.monto.value) < widget.montoAbono!) {
      helperMessage = 'Cuota del mes: ${CtUtils.formatCurrency(
        widget.montoAbono,

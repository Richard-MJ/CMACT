...
class _ConfirmarView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool disabledButton = isTokenInvalid || isAdelantoInvalid;
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Text(
                      CtUtils.formatCurrency(
                        pagoCreditoState.tipoPagoCredito.esAnticipo()
                            ? double.parse(pagoCreditoAnticipoState
                                .montoAnticipo.value)
                                  ...
                                  ..onTap = () async {
                                    await ref
                                        .read(pagoCreditoAnticipoProvider
                                            .notifier)
                                        .showCondicionesModal(context: context, 
                                          tipoPagoCredito:
                ...
                CtButton(
                  text: 'Confirmar',
                  onPressed: () {
                    ref.read(pagoCreditoTercerosProvider.notifier).confirmar();
                  },

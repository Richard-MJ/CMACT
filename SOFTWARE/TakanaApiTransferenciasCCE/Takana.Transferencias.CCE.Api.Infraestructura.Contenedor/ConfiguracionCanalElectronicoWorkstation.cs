...
{   
    /// <summary>
    /// Configuraciones del servicio SFTP para Canales electronicos
    /// </summary>
    public class ConfiguracionCanalElectronicoWorkstation : IConfiguracionCanalElectronicoWorkstation
    {
        /// <summary>

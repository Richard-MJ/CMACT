...
{
    public class ICDNoDisponibilidadDiarioEstrategia : IServicioGeneracionArchivoEstrategia
    {
        ...
        public ICDNoDisponibilidadDiarioEstrategia(
        ...
        public async Task<byte[]> GenerarArchivo(List<GenerarReporteDTO> datos, Periodo periodo)
        {
            ...
            {
                var datosMonitoreo = dato.AdtoObtenerDatosMonitoreoDiario();
        ...
        /// <param name="datos"></param>
        /// <returns></returns>
        public string ObtenerNombreArchivo(GenerarReporteDTO datos) => datos.NombreArchivoICDNoDisponibilidadDiario;

        /// <summary>
        /// Obtener descripción del Reporte
        /// </summary>
        /// <returns></returns>
        public string ObtenerDescripcionReporte() => "REPORTE DIARIO DEL ANEXO 17: INDICADORES DE CALIDAD DE SERVICIO - ICD DE NO DISPONIBILIDAD";
        ...
        private async Task<byte[]> GenerarArchivoCSV(
            double totalMinutosIndisponible,
            ...
            ReporteICDNoDisponibilidadDTO datosReporte)
        {
            try
            {
                ...
                using (var writer = new StreamWriter(memoryStream, Encoding.UTF8, 1024, leaveOpen: true))
                {
                    ...
                    datosReporte.ActualizarICDNoDisponibilidad(totalMinutosIndisponible);
                    ...
                    using (var csv = new CsvWriter(writer, config))
                    {
                        ...
                        csv.WriteField(totalMinutosIndisponible);
                        ...
                        csv.WriteField(datosEncabezado.Dia);
                        csv.NextRecord();

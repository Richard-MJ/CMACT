...
{
    public class ICDEfectividadBusquedaAliasDiarioEstrategia : IServicioGeneracionArchivoEstrategia
    {
        ...
        public ICDEfectividadBusquedaAliasDiarioEstrategia(IRepositorioGeneral repositorioGeneral)
        {
        ...
        /// <param name="datos"></param>
        /// <returns></returns>
        public string ObtenerNombreArchivo(GenerarReporteDTO datos) => datos.NombreArchivoICDEfectividadBusquedaAliasDiario;

        /// <summary>
        /// Obtener descripción del Reporte
        /// </summary>
        /// <returns></returns>
        public string ObtenerDescripcionReporte() => "REPORTE DIARIO DEL ANEXO 17: INDICADORES DE CALIDAD DE SERVICIO - ICD DE EFECTIVIDAD DE BUSQUEDA DE ALIAS";

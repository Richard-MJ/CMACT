...
{
    public class ICDEfectividadTransferenciasMensualEstrategia : IServicioGeneracionArchivoEstrategia
    {
        ...
        public ICDEfectividadTransferenciasMensualEstrategia(IRepositorioGeneral repositorioGeneral)
        {
        ...
        /// <param name="datos"></param>
        /// <returns></returns>
        public string ObtenerNombreArchivo(GenerarReporteDTO datos) => datos.NombreArchivoICDEfectividadTransferenciasMensual;

        /// <summary>
        /// Obtener descripción del Reporte
        /// </summary>
        /// <returns></returns>
        public string ObtenerDescripcionReporte() => "REPORTE MENSUAL DEL ANEXO 17: INDICADORES DE CALIDAD DE SERVICIO - ICD DE EFECTIVIDAD DE TRANSFERENCIAS";

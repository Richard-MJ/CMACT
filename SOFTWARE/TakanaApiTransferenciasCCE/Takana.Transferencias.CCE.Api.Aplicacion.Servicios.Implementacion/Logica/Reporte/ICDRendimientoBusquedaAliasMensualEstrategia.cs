...
{
    public class ICDRendimientoBusquedaAliasMensualEstrategia : IServicioGeneracionArchivoEstrategia
    {
        ...
        public ICDRendimientoBusquedaAliasMensualEstrategia(IRepositorioGeneral repositorioGeneral)
        {
        ...
        public async Task<byte[]> GenerarArchivo(List<GenerarReporteDTO> datos, Periodo periodo)
        {
            ...
            {
                var parcial = _repositorioGeneral.ObtenerDatosCalidadServicioRendimientoBusquedaAlias(
        ...
        /// <param name="datos"></param>
        /// <returns></returns>
        public string ObtenerNombreArchivo(GenerarReporteDTO datos) => datos.NombreArchivoICDRendimientoBusquedaAliasMensual;

        /// <summary>
        /// Obtener descripción del Reporte
        /// </summary>
        /// <returns></returns>
        public string ObtenerDescripcionReporte() => "REPORTE MENSUAL DEL ANEXO 17: INDICADORES DE CALIDAD DE SERVICIO - ICD DE RENDIMIENTO DE BUSQUEDA DE ALIAS";
            ...
            try
            {
                ...
                using (var writer = new StreamWriter(memoryStream, Encoding.UTF8, 1024, leaveOpen: true))
                {
                    ...
                    using (var csv = new CsvWriter(writer, config))
                    {
                        ...
                        csv.WriteField("Cant. Consultas Totales <= t");
                        csv.WriteField("Cant. Consultas Totales >= tmax");

...
{
    public class ICDRendimientoBusquedaAliasDiarioEstrategia : IServicioGeneracionArchivoEstrategia
    {
        ...
        public ICDRendimientoBusquedaAliasDiarioEstrategia(IRepositorioGeneral repositorioGeneral)
        {
        ...
        /// <param name="datos"></param>
        /// <returns></returns>
        public string ObtenerNombreArchivo(GenerarReporteDTO datos) => datos.NombreArchivoICDRendimientoBusquedaAliasDiario;

        /// <summary>
        /// Obtener descripción del Reporte
        /// </summary>
        /// <returns></returns>
        public string ObtenerDescripcionReporte() => "REPORTE DIARIO DEL ANEXO 17: INDICADORES DE CALIDAD DE SERVICIO - ICD DE RENDIMIENTO DE BUSQUEDA DE ALIAS";
